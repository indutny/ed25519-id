...
exports.generate = function generate(desired, random, options) {
  ...
  options = Object.assign({ reportEvery: 1e9 }, options);
  var REPORT_EVERY = options.reportEvery;
  ...
  for (var counter = 0; ; counter++) {
    ...
    if (counter % REPORT_EVERY === 0 && options.report)
      options.report(counter);
